...
class HelloArView(val activity: HelloArActivity) : DefaultLifecycleObserver {
  ...
  private fun launchInstantPlacementSettingsMenuDialog() {
    ...
    val checked = booleanArrayOf(activity.instantPlacementSettings.isInstantPlacementEnabled, activity.instantPlacementSettings.isGridEnabled)
    AlertDialog.Builder(activity)
      ...
      .setPositiveButton(R.string.done) { _, _ ->
        ...
        activity.instantPlacementSettings.isGridEnabled = checked[1]

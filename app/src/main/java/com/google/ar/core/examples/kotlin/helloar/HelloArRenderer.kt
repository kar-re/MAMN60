...
class HelloArRenderer(val activity: HelloArActivity) :
    ...
    lateinit var snusMesh: Mesh
    lateinit var virtualObjectShader: Shader
    lateinit var snusShader: Shader
    lateinit var snusTexture: Texture
    ...
    override fun onSurfaceCreated(render: SampleRender) {
        ...
        try {
            ...
            snusTexture = Texture.createFromAsset(render, "models/snus.png", Texture.WrapMode.CLAMP_TO_EDGE, Texture.ColorFormat.SRGB)
            ...
            snusMesh = Mesh.createFromAsset(render, "models/snus.obj")
            snusShader =
                    Shader.createFromAssets(
                            render,
                            "shaders/environmental_hdr.vert",
                            ...
                            .setTexture("u_AlbedoTexture", snusTexture)
                            .setTexture("u_Cubemap", cubemapFilter.filteredCubemapTexture)
                            .setTexture("u_DfgTexture", dfgTexture)
        } catch (e: IOException) {
    ...
    override fun onDrawFrame(render: SampleRender) {
        ...
        if (activity.instantPlacementSettings.isGridEnabled) {
            // Visualize planes.
        ...
        for (img in updatedAugmentedImages) {
            ...
            if (img.trackingState == TrackingState.TRACKING) {
                ...
                if (img.trackingMethod != AugmentedImage.TrackingMethod.NOT_TRACKING) {
                    ...
                    when (img.index) {
                        0 -> {
                            ...
                            // Update shader properties and draw
                            snusShader.setMat4("u_ModelView", modelViewMatrix)
                            snusShader.setMat4("u_ModelViewProjection", modelViewProjectionMatrix)
                            val texture = snusTexture

                            snusShader.setTexture("u_AlbedoTexture", texture)

                            Log.i("Test", "Drawing virtual object at: " + pose)
                            render.draw(snusMesh, snusShader, virtualSceneFramebuffer)
